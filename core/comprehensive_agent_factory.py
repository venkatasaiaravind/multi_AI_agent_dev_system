    ...
    def _initialize_agent_roles(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            "qa_engineer": {
                ...
                "expertise": ["testing", "quality_assurance", "automation", "bug_detection", "validation"],
                "model_preference": "reasoning_heavy",
                "description": "Ensures comprehensive quality through systematic testing and validation processes"
            },
            "mlops_specialist": {
                "title": "MLOps Engineering Specialist", 
                "expertise": ["mlops", "model_deployment", "kubernetes", "monitoring", "ci_cd"],
                "model_preference": "coding_heavy",
                "description": "Specializes in deploying and maintaining ML models in production environments"
            },
